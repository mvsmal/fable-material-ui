...
| <span class="prop-name">MaterialProp.Icon</span> | <span class="prop-type">ReactElement</span> |   | Icon element. |
| <span class="prop-name">MaterialProp.Label</span> | <span class="prop-type">ReactElement</span> |   | The content of the label. |
...
| <span class="prop-name">ChipProp.OnDelete</span> | <span class="prop-type">Event->unit</span> |   | Callback function fired when the delete icon is clicked. If set, the delete icon will be shown. |
