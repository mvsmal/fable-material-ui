...
| <span class="prop-name">popperOptions</span> | <span class="prop-type">IHTMLProp list</span> |   | Options provided to the [`popper.js`](https://github.com/FezVrasta/popper.js) instance. |
