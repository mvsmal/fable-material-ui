...
```fsharp
Fable.MaterialUI.Core.tableFooter (props : seq<IHTMLProp>) (children : seq<ReactElement>) : ReactElement
```
...
| <span class="prop-name">MaterialProp.Component</span> | <span class="prop-type">ReactElementType</span> | <span class="prop-default">"tfoot"</span> | The component used for the root node. Either a string to use a DOM element or a component. |
